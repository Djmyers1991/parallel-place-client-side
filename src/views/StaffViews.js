...
import { TopicList } from "../components/discussions/DiscussionList"
...
export const StaffViews = ({ token, setToken}) => {
  return <>
    <Routes>
        ...
        <Route path="/discussions" element={<TopicList/>}  />
        <Route path="/discussions/:discussionId" element={<CommentList/>}  />
